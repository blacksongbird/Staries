          ...
          <div data-background="img/mym/mym-square.png" class="full-screen bg-img bg-dark-50">
            <div class="hero-content">
              <div class="hero-content-inner">
                ...
                <div data-effect="fadeInUp" class="mt-30 animate-e"><a href="Melodías y Memorias.php" class="scroll btn btn-coffee btn-border-w btn-round btn-medium">Leer Estrella Previa</a></div>
              </div>
            </div><a href="#page" data-start="display: block" data-100-start="display: none" class="btn-scroll-down scroll"></a>
          </div>
        </div>
          ...
          <div class="row mt-60 mt-xs-30">
            <div class="col-md-8 col-md-offset-2 text-center">
              <blockquote data-wow-delay="0.1s" data-wow-duration="1s" class="about-quote wow fadeInUp">
                <p>En esta segunda parte, Tyler continúa narrando las consecuencias de lo ocurrido en sus memorias pasadas, ahora llamadas recuerdos. Sin embargo, en esta continuación, Tyler dirige la historia a un personaje desconocido en específico 2 años más tarde de los últimos relatos, dejando en duda todo lo ocurrido durante esos extensos meses en el instituto, incluyendo a todas las amistades y enemistades forjadas hasta entonces.</p>
              </blockquote>
            </div>
          </div>
        </div>
      ...
      <section id="service" class="pb-40">
        <div class="container">
          ...
          <div data-wow-delay="0.1s" data-wow-duration="2s" class="row mt-60 mt-xs-30 wow fadeIn">
            <div class="col-sm-4 text-center">
              <div class="service-item"><i></i>
                ...
                <div class="service-desc">
                  <br>
                  <div class="col-md-12 text-center"><a href="Canciones y Recuerdos/Dedicatoria y Prólogo/loader/index.html" class="btn btn-coffee btn-border">Leer</a></div>
                </div>
              </div>
            </div>
            <div class="col-sm-4 text-center">
              <div class="service-item"><i></i>
                <h5 class="alt-font">Recuerdo 1</h5>
                <h5 class="alt-font">Alcohol</h5>
                <div class="service-desc">
                  <p>-Sober Up-<br>-AJR feat. Rivers Cuomo-</p>
                  <br>
                  <br>
                  <div class="col-md-12 text-center"><a href="Canciones y Recuerdos/Recuerdo 1/loader/index.html" class="btn btn-coffee btn-border">Leer</a></div>
                </div>
              </div>
            </div>
            <div class="col-sm-4 text-center">
              <div class="service-item"><i></i>
                <h5 class="alt-font">Recuerdo 2</h5>
                <h5 class="alt-font">Fiestas</h5>
                <div class="service-desc">
                  <p>-Without You-<br>-Avicii feat. Sandro Cavazza-</p>
                  <br>
                  <br>
                  <div class="col-md-12 text-center"><a href="Canciones y Recuerdos/Recuerdo 2/loader/index.html" class="btn btn-coffee btn-border">Leer</a></div>
                </div>
              </div>
            </div>
            <div class="col-sm-4 text-center">
              <div class="service-item"><i></i>
                <h5 class="alt-font">Recuerdo 3</h5>
            ...
            <div class="col-sm-4 text-center">
              <div class="service-item"><i></i>
                <h5 class="alt-font"><br>Recuerdo !</h5>
                <h5 class="alt-font">Interludio</h5>
                <div class="service-desc">
