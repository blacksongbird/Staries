...
<head>
    ...
    <link href="../css/styledestello.css" rel="stylesheet">
    ...
    <link id="theme" href="../css/theme/destello.css" rel="stylesheet">
    <style media="screen">
      #redes-sociales a:before{
        border:1px solid #AE599C;
      }
  ...
  <body class="appear-animate">
          ...
          <div data-background="../img/portfolio/condicion.png" class="full-screen bg-img bg-dark-50">
            <div class="hero-content">
              <div class="hero-content-inner">
                ...
                <div data-effect="fadeInUp" class="mt-30 animate-e"><a href="../La Condición Humana/La Condición Humana.php" class="scroll btn btn-coffee btn-border-w btn-round btn-medium">Leer Estrella</a></div>
              </div>
            </div><a href="#page" data-start="display: block" data-100-start="display: none" class="btn-scroll-down scroll"></a>
          </div>
        </div>
    ...
    <div id="page" class="page">
          ...
          <div class="row mt-60 mt-xs-30">
            <div class="col-md-8 col-md-offset-2 text-center">
              <blockquote data-wow-delay="0.1s" data-wow-duration="1s" class="about-quote wow fadeInUp">
                <p>A la chica caída del cielo...</p>
              </blockquote>
            </div>
          </div>
        </div>
        <div id="facts" class="small-section bg-light mt-80 mt-xs-80" style="background: 	#AE599C;color: white;">
          <style media="screen">
            ...
            <div class="row">
              <div class="col-md-8 col-md-offset-2 text-center">
                ...
                <blockquote class="testimonial">
                  <p> "Iba consumido en sus propios pensamientos cuando vio como un destello brillante perforaba suavemente la nube gris que se veía a la distancia, dejando un trazo en el cielo que guiaba a lo profundo del bosque."</p>
                  <footer class="testimonial-author">Gabriel Lobo, El Destello Caído del Firmamento</footer>
                </blockquote>
              </div>
            </div>
          </div>
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-8 col-md-offset-2 text-center">
                ...
                <blockquote class="testimonial">
                  <p> "—Es que no lo entiendes. ¿Ya te diste cuenta de que te caíste del cielo? ¡No tienes idea de lo mucho que extrañan tus amigas las estrellas brillar contigo! —exclamó el niño con entusiasmo."</p>
                  <footer class="testimonial-author">El niño, El Destello Caído del Firmamento</footer>
                </blockquote>
              </div>
            </div>
          </div>
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-8 col-md-offset-2 text-center">
                ...
                <h3 class="alt-font">Frases de la Novela</h3>
                <blockquote class="testimonial">
                  <p> "Pensando en tí mismo jamás alcanzaras tu propia felicidad. Si no sacrificamos todo lo que tenemos para ayudar a alguien más, ¿qué sentido crees que tendría nuestra vida?"</p>
                  <footer class="testimonial-author">Madre del niño, El Destello Caído del Firmamento</footer>
                </blockquote>
              </div>
            </div>
          </div>
      ...
      <!-- Page Footer Start-->
      <footer class="page-footer" style="background:	#AE599C; color: white;">
