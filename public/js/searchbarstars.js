...
Stars = function(){
  var num = (Math.min(window.innerWidth, window.innerHeight) / Math.max(window.innerWidth, window.innerHeight)) * 1000, //Math.abs(window.innerWidth - window.innerHeight),
    makeStar = function(){
      return {
...
background = function(){
  ...
  grdnt.addColorStop(0, "#21759B");
  grdnt.addColorStop(.5, "#21759B");
  grdnt.addColorStop(1, "#21759B");
  ctx.fillStyle = grdnt;
